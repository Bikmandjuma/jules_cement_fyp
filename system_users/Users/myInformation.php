<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST['edit_info'])) {
            $sql="UPDATE users SET name='$name_x',phone='$phone_x',email='$email_x' WHERE u_id='$users_id'";
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#" onclick="window.location.href='myInformation.php'"><i class="fa fa-list-alt"></i>&nbsp;&nbsp;My info</a></li>
                    ...
                    <div class="card-body" style="overflow: auto;">
                      ...
                      <div class="row">
                          <div class="col-md-12 text-center">
                              <img onclick="window.location.href='profile.php';" src="../../assets/img/users/<?php echo $user_image;?>" class="img-circle elevation-2" alt="User Image" style="width:100px;height:100px;border-radius:50%;border:1px solid skyblue;z-index: 1;display: relative;margin-top:1px; ">
