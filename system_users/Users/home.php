  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-info" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="#" target="_blank">
        <img src="../../assets/img/users/<?php echo $user_image;?>" title="user image" style="width:40px;height:40px;border-radius:50%;" class="navbar-brand-img img-circle" alt="main_logo">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
          ...
          <div class="card" onclick="window.location.href='file_storage.php'">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">File storage</p>
                <h4 class="mb-0"><?php echo $cement->users_counts();?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
              <p class="mb-0"><span class="text-success text-sm font-weight-bolder"><?php echo $cement->users_counts();?></span> all files</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        ...
        <div class="col-xl-1 col-sm-6"></div>
      </div>
      <!-- <div class="row mt-4">
